...
/**
 * "Damage Boost" is the only module whose bonus isn't passive — it only applies
 * once linked to a specific fitted weapon in-game (`SHIP MODULE LINK <#> TO <#>`).
 * Matched on the "linked module" phrase in its effect text rather than by name/id.
 */
...
/**
 * Cargo Hold I/II/III grant a flat tons bonus, unlike every other modded stat
 * (a percentage delta) — parsed off the "<N> extra cargo space" phrasing rather
 * than hardcoded to these modules' names/ids. Returns 0 if no such bonus.
 */
